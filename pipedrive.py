...
LeadScoreID = "88ec7b3fd70f2fbdabe9aded639e316ff29174ce"
...
class PipedriveClient():
  ...
  def update_score(self, person_id, score):
    ...
    url = self.endpoint + res + "/%s?api_token=%s" % (person_id, self.api_token)
...
class BaseResource(object):
  ...
  @property
  def _data(self):
    if self._data_cache == None:
      (r, data) = self._client.fetch_resource_by_id(self.RESOURCE_SEGMENT, self.id)
      self.url = r.url
